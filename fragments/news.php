...
<div class="news">
		...
		<?php while ( $news_loop->have_posts() ) : $news_loop->the_post(); ?>
			<div class="news-item">
				<?php if ( has_post_thumbnail() ) : ?>
					<div class="news-item__image" style="background-image: url(<?php the_post_thumbnail_url('full'); ?>);">
	...
	carbon_pagination( 'posts', [
		...
		'prev_html' => false,
		'number_html' => false,
		'next_html' => '<a href="{URL}" class="paging__next">' . esc_html__( 'Load More', 'crb' ) . '</a>',
	] );
	?>
	</div><!-- news__actions -->
</div><!-- news -->